...
public class BattleScene : MonoBehaviour
{
    ...
    {
        m_turn++;
        playerDinoField.RollingMedal();
        enemyDinoField.RollingMedal();
    }

    private void MakePlayerDeck()
    {
        m_playerDeck = new Deck();
    ...
    {
        playerDinoField.SelectDinoAction();
        enemyDinoField.SelectDinoAction();
