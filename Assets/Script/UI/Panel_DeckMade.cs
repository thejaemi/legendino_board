...
public class Panel_DeckMade : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        m_Label_Attack.text = string.Format("{0}", CM_Singleton<GameData>.instance.m_MyInfo.m_Stat_Card.m_Attack);
        m_Label_Defence.text = string.Format("{0}", CM_Singleton<GameData>.instance.m_MyInfo.m_Stat_Card.m_Defence);
        m_Label_Counter.text = string.Format("{0}", CM_Singleton<GameData>.instance.m_MyInfo.m_Stat_Card.m_Counter);
